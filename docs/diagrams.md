...
```mermaid
stateDiagram-v2
  [*] --> กำลังเตรียมตัว: ผู้ดูแลสร้างและมอบหมาย Job
  กำลังเตรียมตัว --> กำลังเดินทาง: ช่างเริ่มเดินทาง
  กำลังเดินทาง --> เริ่มดำเนินงาน: ถึงหน้างาน
  เริ่มดำเนินงาน --> ส่งงานแล้ว: บันทึกผล/รูป/สารเคมี
  ส่งงานแล้ว --> เสร็จสิ้นและตรวจรับ: ผู้ดูแลอนุมัติ
  เสร็จสิ้นและตรวจรับ --> [*]
```
